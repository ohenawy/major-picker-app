...
(()=>{
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .btn:disabled{cursor:not-allowed;box-shadow:2px 2px 0 var(--ink)}
  ...
  @media(max-width:520px){
    ...
    .l3amberbar{position:fixed;bottom:0;left:0;right:0;height:env(safe-area-inset-bottom);background:rgba(217,119,6,.35);pointer-events:none;z-index:50}
    ...
    <div style={{minHeight:'100vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',position:'relative',overflowX:'hidden'}}>
      ...
      {view==='calculating'&&(
        <div className="fu" style={{textAlign:'center',position:'relative',zIndex:1,padding:'2rem'}}>
          ...
          <div style={{fontSize:'.85rem',color:'var(--muted)',fontWeight:500}}></div>
        </div>
      )}
